...
const Navbar = () => {
   ...
   const {
      ...
      setUser,
      setShowUserLogin,
      navigate, setSearchQuery, searchQuery, getCartCount, axios
   } = useAppContext();
            ...
            {!user ? (<button onClick={() => setShowUserLogin(true)} className="cursor-pointer px-8 py-2 bg-primary-dull hover:bg-primary transition text-white rounded-full">
               ...
               (
                  <div className='relative group'>
                     ...
                     <ul className='hidden group-hover:flex absolute top-10 right-0 bg-white shadow-md border border-gray-200 py-2.5 w-30 rounded-md flex-col p-4 text-sm z-40'>
